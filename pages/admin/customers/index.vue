...
<!--          </form>-->
          ...
          <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              <li>
                <a class="dropdown-item" href="/admin/orders/report" target="_blank">
    ...
    <client-only>
      <Suspense timeout="0">
        <LazyAdminCustomersTable :key="tableComponentKey" :search-keyword="searchKeyword" :items-per-page="itemsPerPage"  />
