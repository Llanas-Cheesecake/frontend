...
const emit = defineEmits<{
  (e: 'cancel'): void,
  (e: 'updatePromotion', promotion: Promotion): void
}>();

const isSubmitting = ref(false);
const imageUrl = ref(props.promotion.image);
...
const form = reactive<{
  ...
  image: null,
  text: props.promotion.text as string,
  buttonText: props.promotion.button_text as string,
  buttonLink: props.promotion.button_link as string
});
...
const handleFormSubmit = async () => {
  ...
  const { data: result, error } = await useFetchAPI<ApiResponse>(`/admin/settings/promotions/${props.promotion.id}`, {
    method: "POST",
    body: data,
    headers: {
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-body">
            ...
            <div v-if="!imageUrl">
              <AdminUploadBox :errors="validation.image" @input-changed="validation.image = []" @image-uploaded="handleImageUpload" />
