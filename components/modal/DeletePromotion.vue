...
const emit = defineEmits<{
  (e: 'cancel'): void,
  (e: 'confirm', promotion_id: number): void
}>();
...
const confirmDelete = async () => {
  ...
  const { data: result, error } = await useFetchAPI(`/admin/settings/promotions/${props.promotion_id}`, {
    method: "DELETE"
  })

  if (result.value) {
    isDeleting.value = false;
    emit('confirm', props.promotion_id)
  }
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-body">
            ...
            <p>Are you sure you want to delete this promotion? This action is irreversible.</p>
